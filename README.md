...
where $\phi_0$ is the baseline prediction and $\phi_j$ is the contribution of feature $j$. In building thermal modeling, SHAP values can be used to quantify how outdoor temperature, solar irradiance, occupancy, HVAC power, and historical indoor temperature contribute to the predicted temperature [\[XAI-1\]](https://proceedings.neurips.cc/paper/2017/hash/8a20a8621978632d76c43dfd28b67767-Abstract.html).

LIME (Local Interpretable Model-agnostic Explanations) explains individual predictions by fitting a simple interpretable model around the local neighborhood of a specific input sample. This can help identify why the model predicts a high cooling load or a rapid temperature increase at a particular time [\[XAI-2\]](https://dl.acm.org/doi/10.1145/2939672.2939778).
...
[[XAI-1]](https://proceedings.neurips.cc/paper/2017/hash/8a20a8621978632d76c43dfd28b67767-Abstract.html) Lundberg, S. M., & Lee, S.-I. (2017). A unified approach to interpreting model predictions. *Advances in Neural Information Processing Systems*, 30.

[[XAI-2]](https://dl.acm.org/doi/10.1145/2939672.2939778) Ribeiro, M. T., Singh, S., & Guestrin, C. (2016). “Why should I trust you?”: Explaining the predictions of any classifier. *Proceedings of the 22nd ACM SIGKDD International Conference on Knowledge Discovery and Data Mining*, 1135-1144.
